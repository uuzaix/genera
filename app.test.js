...
describe('getNextDueEntryForToday', function() {
    it('should return most due entry', function() {
        ...
        expect(nextDueEntry).to.deep.equal({id: 5, due: new Date(2015, 1, 1), word: {id: 5, word: 'femme', genus: 'F', rank: 5, frequency: 1049.32}, superMemoData: {interval: 1, EF: 1.3, repetition: 2}});
    });
});
